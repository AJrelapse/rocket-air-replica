...
const Header = () => {
    ...
    return (
        <div ref={ref} className="bg-black text-white h-[60vh] flex flex-col justify-center items-center">
            <div className="relative flex items-center justify-between w-[90%]">
                <animated.div 
                    style={fadeInLeft} 
                    className={`${aeonikPro.className} text-[5rem] font-semibold leading-[1] text-left pb-10`}
                >
                ...
                <animated.div 
                    style={fadeInRight} 
                    className={`${aeonikPro.className} text-[5rem] font-semibold leading-[1] text-right pt-32`}
                >
